  ...
  return (
    ...
    >
      ...
      <SEO
        ...
        og={{ type: "website" }}
        keywords={["Cookie Policy", "Kaumudi Academy cookies", "Graphura India Private Limited privacy", "Website tracking policy"]}
        jsonLd={[
          {
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Cookie Policy", item: (typeof window !== "undefined" ? window.location.origin : "") + "/cookies" },
            ],
          },
        ]}
      />

      {/* HERO — same as privacy */}
          ...
          >
            ...
            <motion.section variants={rise}>
              ...
              <p className="text-base sm:text-lg md:text-xl leading-relaxed text-[#5f4334]">
                We preserve sacred learning traditions while embracing responsible digital practices—protecting your privacy at every step.
              </p>
            </motion.section>
            ...
            <motion.section variants={rise}>
              ...
              <p className="text-base sm:text-lg text-[#5f4334]">
                Cookies help maintain sessions, preferences, and platform security during your learning journey.
              </p>
            </motion.section>
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center gap-3 flex-wrap mb-2">
                        ...
                        <p className="text-sm sm:text-base font-semibold text-[#7b2d1f]">{item.title}</p>
                        {item.disabled && (
                      ...
                      <p className="text-sm text-[#5f4334] leading-relaxed">{item.desc}</p>
                    </div>
...
<div className="flex justify-center">
  <motion.button
    ...
    style={{
      ...
      color: "#d19a5b",
      boxShadow: "6px 6px 16px rgba(50,20,10,0.35), -3px -3px 10px rgba(255,255,255,0.08), inset 0 1px 0 rgba(255,200,120,0.15)",
      minWidth: "220px",
      maxWidth: "340px",
      width: "100%",
    }}
  >
    ...
    <motion.div
      ...
      style={{
        ...
        width: "60%",
        height: "100%",
        background: "linear-gradient(105deg, transparent 20%, rgba(231, 205, 145, 0.7) 50%, transparent 80%)",
        pointerEvents: "none",
        zIndex: 1,
    ...
    <motion.div
      animate={saveHovered ? { rotate: 18, color: "#ffffff" } : { rotate: 0, color: "#d19a5b" }}
      transition={{ type: "spring", stiffness: 300 }}
